...
public class SemiProductTestBuilder {
    ...
    private BigDecimal minimalStockQuantity = new BigDecimal("1000");
    ...
    public SemiProductTestBuilder withMinimalStockQuantity(BigDecimal minimalStockQuantity){
        this.minimalStockQuantity = minimalStockQuantity;
        return this;
    }

    public SemiProductTestBuilder withSubcategoryId(Long subcategoryId) {
