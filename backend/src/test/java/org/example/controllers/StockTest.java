    ...
    class GetStockItemsTest {
        ...
        void getStockItems_Success() {
            ...
            .then()
                ...
                .body("$", notNullValue())
                .body("$", hasSize(9))
                    .body("[0].semiProductDTO.name", notNullValue())
                    .body("[0].semiProductDTO.unit", notNullValue())
                    .body("[0].semiProductDTO.minimalStockQuantity", notNullValue())
                .statusCode(200);
        ...
        void getEmptyStockListItems_Success() {
            given()
                    ...
                    .log().all()
                    .statusCode(200)
                    .body("$", empty()); // Weryfikuje, czy główna tablica jest pusta
        }
